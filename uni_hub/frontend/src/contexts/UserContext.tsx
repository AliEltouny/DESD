...
export const UserProvider: React.FC<UserProviderProps> = ({ children }) => {
  ...
  const fetchUserProfile = useCallback(async (): Promise<User | null> => {
    ...
    try {
      ...
      // This assumes the apiClient instance used here either shares interceptors
      // with AuthContext's client or has its own interceptor setup.
      // Alternatively, get the token and set it manually for this request.
