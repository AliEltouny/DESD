...
import * as ReactRadix from "react";
...
const ButtonRadix = ReactRadix.forwardRef<HTMLButtonElement, ButtonProps>(
...
ButtonRadix.displayName = "ButtonRadix";

export { ButtonRadix, buttonVariants };
