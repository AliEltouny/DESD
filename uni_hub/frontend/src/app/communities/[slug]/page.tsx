    ...
    const fetchCommunityData = async () => {
      try {
        ...
        try {
          ...
          if (communityErr.message && communityErr.message.includes("not found")) {
            setError(`Community "${slug}" not found. It may have been deleted or never existed.`);
          } else if (communityErr.message && communityErr.message.includes("permission")) {
            setError("You don't have permission to access this community.");
          } else {
