...
class PostAPI {
  ...
  async createPost(communitySlug: string, data: PostFormRequest): Promise<Post> {
    try {
      ...
      if (hasFileUploads) {
        ...
        console.log(`Sending post creation request to: /communities/${communitySlug}/posts/`);
  ...
  async upvotePost(communitySlug: string, postId: number): Promise<ApiSuccessResponse> {
    try {
      const response = await api.post<ApiSuccessResponse>(
        `/communities/${communitySlug}/posts/${postId}/upvote/`
      );
      return response.data;
    } catch (error) {
  ...
  async togglePinPost(communitySlug: string, postId: number): Promise<ApiSuccessResponse> {
    try {
      const response = await api.post<ApiSuccessResponse>(
        `/communities/${communitySlug}/posts/${postId}/toggle_pin/`
      );
      return response.data;
    } catch (error) {
  ...
  async updateComment(
    ...
    try {
      const response = await api.patch<Comment>(
        `/communities/${communitySlug}/posts/${postId}/comments/${commentId}/`,
        data
      );
      return response.data;
    } catch (error) {
  ...
  async upvoteComment(
    ...
    try {
      const response = await api.post<ApiSuccessResponse>(
        `/communities/${communitySlug}/posts/${postId}/comments/${commentId}/upvote/`
      );
      return response.data;
    } catch (error) {
